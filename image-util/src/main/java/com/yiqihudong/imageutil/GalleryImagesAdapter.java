...
public class GalleryImagesAdapter extends BaseAdapter {
    ...
    //还可以选择的图片数
    private int canSelect = Constant.IMAGE_MAX;
                ...
                viewHolder.mCheckBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (isChecked && mSelectMap.size() >= canSelect && !mSelectMap.containsKey(path)) {
                            ...
                            Toast.makeText(viewHolder.mCheckBox.getContext(), viewHolder.mCheckBox.getContext()
                                    .getString(R.string.can_select_photo_max)+canSelect + "",Toast.LENGTH_SHORT).show();
                            return;
                        }
